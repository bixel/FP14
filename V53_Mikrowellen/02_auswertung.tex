...
Für die elektronische Bandbreite $B$ des Klystrons hat sich nach Gleichung \eqref{bandbreite} 
...
\begin{table}
	...
	\end{tabular}
	\caption{Ergenisse der SWR-Meter Methode.}
	\label{v3:1}
	\begin{tabular}{r r r r r r r}
	...
	\end{tabular}
	\caption{Ergenisse der 3dB-SWR-Methode.}
	\label{v3:2}
	...
	\end{tabular}
	\caption{Ergenisse der Abschwächer-Methode.}
	\label{v3:3}
\end{table}
