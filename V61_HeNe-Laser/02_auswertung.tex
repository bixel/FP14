...
Der gemessene Wert des konvexen Spiegels stimmt dabei mit dem
theoretischen Wert
$d_\text{max,konvex}^\text{theorie} d_\text{max,plan}^\text{theorie}
= \SI{1}{\meter}$ überein (siehe Gleichung \eqref{eqn:stabi}),
während die Messung des maximales Abstandes des
planen Spiegels stark abweicht.
