...
$\Delta T = \input{build/delta_t.tex}$. Mit der Periodendauer der
Trägerfrequenz $T_\text{T} = \input{build/t_t.tex}$ ergibt sich eine
Frequenzverbreiterung von $\Delta f = \input{build/delta_f.tex}$ und
