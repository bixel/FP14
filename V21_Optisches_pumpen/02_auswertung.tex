...
Bei der Untersuchung der Perioden der RF-Modulation errechnete sich ein Wert von $\input{build/tex/i_fit_T_quot.tex}$, welcher um etwa $\SI{11}{\percent}$ vom Theoriewert $\SI{1.5}{}$ abweicht.
