...
beeinflusst wird und einen Phasensprung um $\varphi_\Gamma$ vollziehen kann.
...
bezeichnet:
\begin{equation*}
    \Gamma = \frac{U_\text{r}}{U_0} = \frac{Z_\text{L} - Z_0}{Z_\text{L} + Z_0} = \left|\e^{\i\varphi_\Gamma}\right|\,.
\end{equation*}
...
\subsection{Bestimmung der Leitungsimpedanz $Z_0$} % (fold)
\label{sub:impedanz}
