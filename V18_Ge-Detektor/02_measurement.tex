...
Um das entsprechende Energiespektrum zu erhalten, wird den Kanälen mit einer lineare Kalibrationsfunktion $E(C)$ eine jeweilige Energie $E$ zugeordnet.
...
Zunächst wird das Spektrum eines $^{52}$Eu-Strahlers aufgenommen.
Um den Einfluss von Untergrundereignisse zu verringern, wird ebenfalls eine Leermessung durchgeführt und die Einträge der einzelnen Kanäle von dem Spektrum des $^{52}$Eu-Strahlers abgezogen.
...
Dabei werden die in Tabelle \ref{tab:maxima} aufgeführten Maxima gewählt und den jeweiligen Kanäle mit Hilfe von \eqref{eqn:kalibration} eine Energie zugeordnet.
