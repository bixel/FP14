...
Die Paramter dieser Funktion werden dabei durch Fit an den in Abbildung \ref{fig:compton_fit} markierten Bereich bestimmt. Damit ergibt sich
\begin{align*}
    I_\text{C} = \num{47190+-220}\,.
\end{align*}
...
% subsection aktivit_t_einer_ (end)
