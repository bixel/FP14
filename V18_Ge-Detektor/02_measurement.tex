...
Zunächst wird das Spektrum eines $^{152}$Eu-Strahlers aufgenommen (Abb.
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[t]{.49\linewidth}
        \includegraphics[width=1.0\linewidth]{build/plots/eu_dist.pdf}
        \caption{
            Energiespektrum des $^{152}$Eu-Strahlers. Die zur Kalibration
            genutzten Maxima sind durch eine gestrichelte Linie markiert.
            Messdauert $t = \SI{2970}{s}$.
        }
        \label{fig:eu_uncalibrated}
    \end{subfigure}%
    \begin{subfigure}[t]{.49\linewidth}
        \includegraphics[width=1.0\linewidth]{build/plots/calibration.pdf}
        \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{build/plots/comparison.pdf}
    \caption{
...
\begin{table}[htb]
    ...
    \caption{
        ...
        In den rechten Spalten sind die Literaturwerte aufgeführt, die zur Kalibration
        genutzt werden. In der Spalte \enquote{erwartet} sind die nach Aktivitätsbestimmung
        erwarteten Ereignisse aufgeführt.
    }
    \label{tab:maxima}
    \begin{tabular}{%
        S[table-format=4.2]%
        ...
        \toprule
        \multicolumn{2}{c}{Referenz\cite{V18}} &
        \multicolumn{3}{c}{Messung} \\
        {Energie\:/\:\si{keV}} &
        ...
        \midrule
        121.78 & 28.6 &  358 & 12520(50) & 20068(365) & 62.4(12) \\
...
\end{align*}
Für die Aktivität $A$, die im Detektor gemessen werden kann und mit Berücksichtigung
der Messdauer $t = \SI{2964}{\second}$, gilt schließlich
\begin{align*}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.7\linewidth]{build/plots/efficiency.pdf}
    \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{build/plots/caesium_gauss.pdf}
    \caption{
...
\subsection[Aktivität einer $^{133}$Ba-Quelle]%
    {Aktivität einer $\mathbf{^{133}}$Ba-Quelle} % (fold)
\label{sub:ba_quelle}
...
\begin{align*}
    A_\text{ges} = \SI{393+-21}{\becquerel}\,.
\end{align*}
\begin{figure}
    \centering
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{
            ...
            Messdauert $t = \SI{3551}{s}$.
        }
        \label{fig:ba_spektrum}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \includegraphics[width=1.\linewidth]{build/plots/ba_activity.pdf}
        \caption{
...
\begin{table}
    ...
    \begin{tabular}{%
        ...
        \toprule
        {Peak\:/\:\si{keV}}  & {Ereignisse} & {Emissionsw.\:/\:\si{\percent}\cite{V18}} \\
        \midrule
         81.12(1) & 3940(140) & 34.1 \\
        160.74(4) &    97(11) &  0.6 \\
        302.49(1) &  1413(14) & 18.3 \\
        356.09(1) &  4040(50) & 62.1 \\
        383.92(1) &    540(8) &  8.9 \\
        \bottomrule
    \end{tabular}
\end{table}
...
Inhalt auf.
Die Anzahl der Untergrundereignisse aus dem Fit werden dann von der Zahl der
Signalkandidaten abgezogen, sodass ingsesamt die in der Tabelle aufgeführte
Anzahl von Ereignissen mit Kandidaten des jeweiligen Strahlers identifizert werden.
